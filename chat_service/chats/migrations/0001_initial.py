    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_handle', models.CharField(db_index=True, max_length=32, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_title', models.CharField(blank=True, max_length=50, null=True, verbose_name='Кастомный титул (префикс)')),
                ('can_manage_titles', models.BooleanField(default=False, verbose_name='Может менять титулы другим')),
